  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="login_form.php"><b>log In</b></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="register_form.php"><b>Registration</b></a>
        </li>
        <li class="nav-item">
   ...
   <div class="container-fluid">
      <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-12">
           ...
           <p class="py-3">
           Online banking allows a user to conduct financial transactions via the Internet. Online banking is also known as Internet banking or web banking. Online banking offers customers almost every service traditionally available through a local branch including deposits, transfers, and online bill payments.</p>
   ...
   <div class="container-fluid">
      <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-12">
           ...
           <p class="py-3">What services do you use from your bank?
...
<footer class="text-center text-lg-start bg-light text-muted" >
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fas fa-phone me-3"></i> 90283 30845</p>
          <p><i class="fas fa-print me-3"></i> 92266 56894</p>
        </div>
        <!-- Grid column -->
      </div>
      <!-- Grid row -->
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
    © 2021 Partner Bank :
    <a class="text-reset fw-bold" href="#"> Designed & Created By Abhinav & Dhanshri </a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
